...
class DemographicStatistic(models.Model):
    ...
    @classmethod
    def get_aggregated_by_both_sexes(cls, year: int, age_group: AgeGroup, hd_index: HDIndex) -> int:
        """
    ...
    @classmethod
    def get_breakdown_by_sex(cls, year: int, age_group: AgeGroup, hd_index: HDIndex) -> Dict[str, int]:
        """
